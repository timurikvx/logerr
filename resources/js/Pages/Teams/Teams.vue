<template>
    <Layout class="teams flex flex-col overflow-hidden grow">
        <div class="flex mb-2">
        ...
        <div class="flex flex-col grow content p-4">
            <div v-for="item in teams" class="flex mb-4 team">
                <a class="flex grow item" :class="{'active': crew?.guid === item.guid}" :href="'/team/' + item.guid">
